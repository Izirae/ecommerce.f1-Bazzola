...
function ItemListContainer({ msg }) {
	...
	useEffect(() => {
		let gear = [
			{
				id: 1,
				model: "Gorra McLaren - Special Edition",
				brand: "New Era",
				price: 56,
				imgURL:
					"https://images.footballfanatics.com/mclaren-f1-team/mclaren-2022-new-era-special-edition-9forty-fade-cap_ss4_p-13301974+u-t0qx77ypmm369udcck74+v-2222ef1ae79c4a51849fb90f3b463413.jpg?_hv=1&w=340",
			},
			{
				id: 2,
			...
			},
			{
				...
				price: 76,
				imgURL:
					"https://images.footballfanatics.com/scuderia-ferrari/scuderia-ferrari-2022-team-t-shirt-womens_ss4_p-13300704+u-un2adu6mxf3lzeygji2s+v-6173b147d6af44fb9d227132bcbd0dca.jpg?_hv=1&w=900",
			},
			// {
			// 	id: 6,
